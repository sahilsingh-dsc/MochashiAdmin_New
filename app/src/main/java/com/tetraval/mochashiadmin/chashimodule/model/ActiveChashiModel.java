...
public class ActiveChashiModel {
    ...
    public ActiveChashiModel() {
    }

    public ActiveChashiModel(String p_uid, String p_fname, String p_lname, String p_imagel, String p_address, String p_lat, String p_long, String p_email, String p_status) {
        this.p_uid = p_uid;
